...
WELCOME = (
    ...
    "می‌تونی به‌صورت تکی بازی کنی و سکه جمع کنی، یا دوستت رو به چالش دعوت کنی و "
    "روی نتیجه شرط ببندید.\n\n"
    "از منوی زیر شروع کن 👇"
)
...
HELP_TEXT = (
    ...
    "⚔️ <b>چالش با دوست:</b> با ریپلای‌کردن روی پیام دوستت و زدن دکمه، یا با فرستادن "
    "یوزرنیمش، باهاش سکه شرط می‌بندید و هرکی برنده بشه کل شرط رو می‌بره.\n"
