...
WELCOME = (
    ...
    "می‌تونی به‌صورت تکی بازی کنی و سکه جمع کنی، یا در بازی چندنفره تعداد بازیکن‌ها رو انتخاب کنی و حریف تصادفی پیدا کنی.\n\n"
    "🎮 بازی چندنفره داخل چت خصوصی بات انجام می‌شه و نیازی به وارد کردن آیدی یا ساخت لابی نیست.\n\n"
    "از منوی زیر شروع کن 👇"
)
...
HELP_TEXT = (
    ...
    "⚔️ <b>بازی چندنفره:</b> تعداد ۲، ۳ یا ۴ نفر را انتخاب کن و «جستجوی حریف» بزن؛ بات به‌صورت خودکار بازیکن‌های منتظر را با هم مچ می‌کند و بازی داخل بات شروع می‌شود.\n"
